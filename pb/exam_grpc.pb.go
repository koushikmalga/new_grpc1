...
type GCDServiceClient interface {
	...
	Compute1(ctx context.Context, in *GCDRequest, opts ...grpc.CallOption) (*GCDResponse, error)
}
...
type GCDServiceServer interface {
	...
	Compute1(context.Context, *GCDRequest) (*GCDResponse, error)
...
func (UnimplementedGCDServiceServer) Compute1(context.Context, *GCDRequest) (*GCDResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Compute1 not implemented")
}
...
func _GCDService_Compute1_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GCDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GCDServiceServer).Compute1(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var GCDService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Compute1",
			Handler:    _GCDService_Compute1_Handler,
		},
	},
